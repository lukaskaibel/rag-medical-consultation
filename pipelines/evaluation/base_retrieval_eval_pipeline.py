...
def get_base_retrieval_eval_pipeline(
    ...
    base_retrieval_pipeline = pipelines.retrieval_pipelines.base_retrieval_pipeline.get_base_retrieval_pipeline(base_indexing_store, embedding_model_config, reranking_model_config)
